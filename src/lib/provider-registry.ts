...
export const providerRegistry: Record<ProviderId, {
  ...
  "cems-rapid-mapping": { sourceId: "cems", mode: "complementary", cadenceMinutes: 10, hazards: ["wildfire", "industrial", "civil-emergency", "flood"], limitationCode: null, displayName: "Copernicus EMS Rapid Mapping", roleLabel: "Complementary emergency source", officialUrl: "https://mapping.emergency.copernicus.eu/", limitation: "Rapid Mapping is context only and does not establish current monitoring.", healthScope: "non_blocking", satisfiesCoverage: false },
