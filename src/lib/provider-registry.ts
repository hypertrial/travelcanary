...
export const providerRegistry: Record<ProviderId, {
  ...
  meteoalarm: { sourceId: "meteoalarm", mode: "authoritative", cadenceMinutes: 30, hazards: ["severe-weather", "flood", "extreme-heat", "extreme-cold", "wildfire", "snow-ice", "avalanche", "coastal"], limitationCode: null, displayName: "MeteoAlarm", roleLabel: "Official warning source", officialUrl: "https://meteoalarm.org/", limitation: null },
  usgs: { sourceId: "usgs", mode: "authoritative", cadenceMinutes: 30, hazards: ["earthquake"], limitationCode: null, displayName: "USGS", roleLabel: "Primary earthquake source", officialUrl: "https://earthquake.usgs.gov/", limitation: null },
  ...
  "cems-rapid-mapping": { sourceId: "cems", mode: "complementary", cadenceMinutes: 30, hazards: ["wildfire", "industrial", "civil-emergency", "flood"], limitationCode: null, displayName: "Copernicus EMS Rapid Mapping", roleLabel: "Complementary emergency source", officialUrl: "https://mapping.emergency.copernicus.eu/", limitation: "Rapid Mapping is context only and does not establish current monitoring.", healthScope: "non_blocking", satisfiesCoverage: false },
  ...
  "eea-aqi": { sourceId: "eea", mode: "authoritative", cadenceMinutes: 60, hazards: ["air-quality"], limitationCode: "station_observations_partial", displayName: "European Environment Agency", roleLabel: "Official station observations", officialUrl: "https://airindex.eea.europa.eu/", limitation: "Only mapped operational stations with observation-backed culprit pollutants provide partial monitoring. Modelled or gap-filled values remain context and never establish an all-clear.", healthScope: "coverage" },
