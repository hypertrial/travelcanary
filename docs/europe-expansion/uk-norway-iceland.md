...
> coverage. A later policy revision retained credential-bound Met Office NSWWS
> as optional, health-neutral, and non-contributing; NRW remains credential-gated
> and non-contributing. The remaining text is
